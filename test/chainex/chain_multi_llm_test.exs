defmodule Chainex.ChainMultiLLMTest do
  ...
  describe "model routing" do
    test "routes to appropriate model based on task" do
      chain =
        Chain.new("Complex reasoning task")
        |> Chain.route_llm(
          %{
